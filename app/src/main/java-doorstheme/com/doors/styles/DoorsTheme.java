...
public class DoorsTheme {
    ...
    public static void checkTheme(Context context) {
        ...
        String colorAccent = prefs.getString("color_accent", "default_blue");
        if (darkMode) {
            ActivityManager.TaskDescription taskDescription = new ActivityManager.TaskDescription(
                    context.getString(R.string.app_name),
                    BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher),
                    ContextCompat.getColor(context, R.color.DoorsTheme_black)
            );
            ...
            ActivityManager.TaskDescription taskDescription = new ActivityManager.TaskDescription(
                    context.getString(R.string.app_name),
                    BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher),
                    ContextCompat.getColor(context, R.color.DoorsTheme_white)
            );
            ((Activity)context).setTaskDescription(taskDescription);
            switch (colorAccent) {
                case "yellow_gold":
